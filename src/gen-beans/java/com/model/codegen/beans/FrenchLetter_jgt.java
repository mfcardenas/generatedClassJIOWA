//
// AUTOMATICALLY GENERATED from template file FrenchLetter.jgt
// 
 ...
 *  
 * Template Bean: FrenchLetter_jgt <br>
...
public class FrenchLetter_jgt extends TemplateBean
{   
    /*------------------------------------------------------------------------*\
     * Fields & constants:                                                    *
    \*------------------------------------------------------------------------*/
     ...
     */
    public static final java.lang.String ID = "FrenchLetter.";            
    
    /*------------------------------------------------------------------------*\
     * Constructors:                                                          *
    \*------------------------------------------------------------------------*/

    public FrenchLetter_jgt()
    {
        initialize();
    }
     ...
     */    
    public FrenchLetter_jgt(TemplateBean parent)
    {
     ...
     */
    public FrenchLetter_jgt setName(java.lang.String value)
    {
     ...
     * @return the reference to the current template bean
     */
    public FrenchLetter_jgt setContactPerson(java.lang.String value)
    {
    ...
    public static class Salutation
    {
         ...
         * the parent bean. 
         */
        protected FrenchLetter_jgt parent = null;
         ...
         */
        protected Salutation(FrenchLetter_jgt parent)
        {
            this.parent = parent;
            if (this.parent != null)
            {
         ...
         */
        protected FrenchLetter_jgt parent()
        {
            return this.parent;        
        }
        ...
        {   
            ...
            /** Upward link from this template bean to host bean FrenchLetter_jgt */
            protected FrenchLetter_jgt FrenchLetter_jgt;     
             ...
             */
            protected Mr(TemplateBean parent, FrenchLetter_jgt hostBean)
            {
                 super(parent);
                 this.FrenchLetter_jgt = hostBean;
                 initialize();
            }
             ...
             * @return the reference to the host bean 'FrenchLetter_jgt'
             */
            public FrenchLetter_jgt FrenchLetter_jgt()
            {   
                return this.FrenchLetter_jgt;
            }
            ...
            protected void initialize()
            {
                ...
                partList.add(new TextPart("Cher Monsieur",0));
            }
        }
        ...
        {   
             ...
             *                 This reference can be used to navigate 'upwards' during the data insertion process.
             */
            protected Mrs(TemplateBean parent, FrenchLetter_jgt hostBean)
            {
                 super(parent);
                 this.FrenchLetter_jgt = hostBean;
                 initialize();
            ...
            protected void initialize()
            {
                ...
                // subtemplates:        
                // bean parts for toString() method:
                partList.add(new TextPart("Chère Madame",0));
            }
        }
         ...
         */
        public FrenchLetter_jgt setAll(TemplateBeanList beanList)
        {
         ...
         * @return reference to current template bean.
         */
        public FrenchLetter_jgt prepend(Mr bean)
        {
         ...
         * @return reference to current template bean
         */
        public FrenchLetter_jgt append(Mr bean)
        {
         ...
         * @return reference to current template bean 
         */
        public FrenchLetter_jgt set(Mr bean)
        {
         ...
         * @return reference to current template bean.
         */
        public FrenchLetter_jgt prepend(Mrs bean)
        {
            parent.subTemplateStructureMap.prepend("Salutation", bean);    
            return parent;
        }
         ...
         * @return reference to current template bean
         */
        public FrenchLetter_jgt append(Mrs bean)
        {
            parent.subTemplateStructureMap.append("Salutation", bean);    
            return parent;
        }
         ...
         * @return reference to current template bean 
         */
        public FrenchLetter_jgt set(Mrs bean)
        {
            parent.subTemplateStructureMap.put("Salutation", bean);
            return parent;
        }
    ...
    protected void initialize()
    {
        ...
        partList.add(new SubTemplateStructurePart("Salutation",0,"Mr","Mrs"));
        partList.add(new TextPart(" ",60));
        partList.add(new VariablePart("Name","<<Name>>",61));
